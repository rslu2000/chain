...
A companion document, the [Chain Protocol whitepaper](../whitepaper/chainprotocol.md), includes motivation for the design choices, usage notes and other discussion.
